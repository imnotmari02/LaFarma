...
<form method="post" action="cambiarpass.php" name="f1">
    ...
    <input type="password" name="clave1"  class="a" placeholder="Ingrese la nueva contraseña"><br><br>
    <input type="password" name="clave2" class="a" placeholder="Repita la nueva contraseña"><br><br>
    <input type="submit" value="cambiar" onClick="comprobarClave()" class="v">
